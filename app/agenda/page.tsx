            ...
            <div className="container">
                ...
                <div className="card">
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column' }}>
                        {MOCK_AGENDA.sort((a, b) => new Date(a.date).getTime() - new Date(b.date).getTime()).map((item, index) => (
                            <div key={item.id} style={{
                                display: 'flex',
                                padding: '24px',
                                borderBottom: index !== MOCK_AGENDA.length - 1 ? '1px solid var(--color-border)' : 'none',
                                gap: '24px',
                                alignItems: 'center'
                            }}>
                                {/* Date Box */}
